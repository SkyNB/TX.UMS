...
public class OauthUser extends AbstractDomain {
    ...
    public OauthUser(String username, String password, String phone, String email) {
    ...
    public OauthUser lastLoginTime(Date lastLoginTime) {
        this.lastLoginTime = lastLoginTime;
        return this;
    }

    public OauthUser createTime(LocalDateTime createTime) {
