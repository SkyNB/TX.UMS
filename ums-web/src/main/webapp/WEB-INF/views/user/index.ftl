...
<#assign bodyEnd>
<script src="${request.contextPath}/resources/pages/user/index.js"></script>
</#assign>
...
<div id="app">
    <div class="nav-bar">
        ...
        <div class="input-group" style="float: right;">
            <input type="text" class="form-control" placeholder="用户名或真实姓名" v-model="search.username" @keyup.enter="onSearch()">
            <div class="input-group-btn">
                <button type="button" class="btn btn-default" aria-label="Help" @click="search.username='';onSearch()"><span class="icon-rotate-cw3"></span></button>
