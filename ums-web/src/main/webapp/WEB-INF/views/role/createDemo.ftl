                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-10">
                                <select kendo-multi-select multiple="multiple" required="required" k-auto-close="false" ng-model="role.permissionsLists" name="permissionsLists" id="permissionsLists">
