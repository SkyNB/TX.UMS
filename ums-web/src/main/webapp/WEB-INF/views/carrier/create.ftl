...
<div id="addCarrier" class="modal fade in" role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="addCarrierForm" class="form-horizontal" ng-submit="submit()" data-role="form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-plus"></i>&nbsp;添加承运商</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                        <@form.Text id="code" label="编码" ngModel="carrier.code" required="required" pattern="[A-Za-z0-9_-]+"/>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <#--<div class="form-group col-sm-6">
                        <@form.Dropdown id="branchCode" label="所属分公司" ngModel="carrier.branchCode" listItem=branches required="required"/>
                        </div>-->
                        <div class="form-group col-sm-6">
