<div id="importCarrier" class="modal fade" role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="importCarrierForm" class="form-horizontal" ng-submit="submit()" role="form"
                  enctype="multipart/form-data" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-file-text-o"></i>&nbsp;导入承运商信息</h4>
                </div>

                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <h4 align="center"><a href="${request.contextPath}/carrier/download?fileName=carrier.xlsx">下载导入模板</a>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                           ...
                           <#--     <span class="fileinput-exists">替换</span>-->
                                <input type="file" name="carrierFile" required="required">
                            </span>
