<div id="importCustomer" class="modal fade " role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="importCustomerForm" class="form-horizontal" ng-submit="submit()" role="form"
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <h4 align="center"><a
                                    href="${request.contextPath}/customer/downLoad?fileName=customer.xlsx">下载导入模板</a>
                            </h4>
                        </div>
                    </div>
