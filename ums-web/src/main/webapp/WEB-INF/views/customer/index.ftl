...
<div ui-view="content" ng-controller="CustomerController">
    <div class="action-bar">
        <a href="#/create" data-target="#addCustomer" data-toggle="modal" kendo-button id="add">
            <i class="fa fa-plus"></i> 增加 </a>

        <a href="#/import" class="k-button" data-target="#importCustomer" data-toggle="modal">
    ...
    <div class="search-bar">
        <form id="fromSearchCustomer" class="form-inline" ng-submit="search()">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="ratingCodeIn">级别</label>
                <div class="col-sm-9">
