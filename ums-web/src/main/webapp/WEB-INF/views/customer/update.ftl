...
<div id="updateCustomer" class="modal fade " role="basic" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="updateCustomerForm" class="form-horizontal" ng-submit="submit()" data-role="form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;修改客户</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="k-textbox" ng-model="customer.fullName"/>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            <label class="control-label col-sm-4" for="active">是否启用</label>
                            <div class="col-sm-8 form-control-static">
                                <input type="checkbox" id="active" ng-model="customer.active" checked disabled="disabled"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-10">
                                <textarea class="k-textbox" ng-model="customer.remark"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div kendo-grid k-data-source="dataSource" k-editable="true" k-toolbar="toolbar"
                             k-columns="columns" id="brandsForUpdate"></div>
                    </div>
