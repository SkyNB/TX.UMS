...
<div id="addShipAddress" class="modal fade in" role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="addShipAddressForm" class="form-horizontal" ng-submit="submit()" data-role="form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-plus"></i>&nbsp;添加发运地址</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                        <@form.Text id="code" label="编码" ngModel="shipAddress.code" required="required" pattern="[A-Za-z0-9_-]+"/>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                        <@form.Dropdown id="carrierCodeForCreate" label="所属承运商" ngModel="shipAddress.carrierCode" listItem=carriers required="required"/>
                        </div>
                    </div>
