...
<#assign bodyEnd>
<script src="${request.contextPath}/resources/pages/organization/index.js"></script>
</#assign>
...
<div id="app">
    <div class="nav-bar">
        ...
        <div class="input-group" style="float: right;">
            <input type="text" class="form-control" placeholder="编码 或名称" v-model="search.searchText">
    ...
    <div id="main-content">
        <div class="grid-wrapper">
            <div id="gridOrganization" class="dynamic-height"></div>
        </div>
    </div>
</div>
