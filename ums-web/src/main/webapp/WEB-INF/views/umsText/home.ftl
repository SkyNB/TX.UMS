...
<div id="app">
    ...
    <div class="main LIGHT" v-bind:class="{'mfx-left':sidebar.isLeft,'mfx-right':!sidebar.isLeft,nofx: !sidebar.isFx }">
        <div id="tabstrip">
            ...
            <div>
                <iframe src="${request.contextPath}/resources/index/demo.2.html"></iframe>
            </div>
        </div>
    </div>
            ...
            <div class="category-content">
                <div class="media">
                    <div class="media-body">
                        <span class="media-heading text-semibold">小禄</span>
                        <div class="text-size-mini text-muted">
                            <i class="icon-pin text-size-small"></i> &nbsp;管理员
                        </div>
                    </div>
...
<script>
        ...
        addNode({src:"${request.contextPath}/resources/index/public/js/to_treeJson.js",load:function(){
            layout.menuBar =transData(${userData}, "menuid", "parentid", "chindren");}
            //---加载菜单
