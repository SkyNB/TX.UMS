...
<div id="addDeliveryAddress" class="modal fade in" role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="addDeliveryAddressForm" class="form-horizontal" ng-submit="submit()" data-role="form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-plus"></i>&nbsp;添加收货地址</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <@form.ComboBox id="customser" label="客户" listItem=customers ngModel="deliveryAddress.ownerCode" required="required"/>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        <div class="form-group  col-sm-12">
                            ...
                            <div class="col-sm-10">
                                <textarea class="k-textbox" ng-model="deliveryAddress.remark"/>
                            </div>
                        </div>
                    </div>
