...
<#assign bodyEnd>
<script src="${request.contextPath}/resources/pages/expenseAccount/index.js"></script>
</#assign>
...
<div id="app">
    <div class="nav-bar">
        ...
        <div class="input-group" style="float: right;">
            <input type="text" class="form-control" placeholder="编码或名称"  v-model="search.name"  @keyup.enter="onSearch()">
    ...
    <div id="main-content">
        <div class="grid-wrapper">
            <div id="gridExpenseAccount" class="dynamic-height"></div>
        </div>
    </div>
</div>
