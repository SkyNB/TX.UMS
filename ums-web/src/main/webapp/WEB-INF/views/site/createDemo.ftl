...
<div id="addSite" class="modal fade in" role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="addSiteForm" class="form-horizontal" ng-submit="submit()" data-role="form">
                ...
                <div class="modal-body">
                    <#--<div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <input kendo-combo-box k-options="branchOptions" ng-model="site.branchCode" required="required" name="branchCode">
                            </div>
                        </div>
                    </div>-->
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="k-textbox" ng-model="site.code" required="required" pattern="[a-zA-Z0-9_-]+" name="code"/>
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
