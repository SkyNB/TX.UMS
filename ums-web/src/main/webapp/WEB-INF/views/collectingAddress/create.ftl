...
<div id="addCollectingAddress" class="modal fade in" role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="addCollectingAddressForm" class="form-horizontal" ng-submit="submit()" data-role="form">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-plus"></i>&nbsp;添加提货地址</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <@form.ComboBox id="customser" label="客户" listItem=customers ngModel="collectingAddress.ownerCode" required="required"/>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <@form.Text id="code" label="编码" ngModel="collectingAddress.code" required="required" pattern="[A-Za-z0-9_-]+"/>
                        </div>
                        <div class="form-group col-sm-6">
