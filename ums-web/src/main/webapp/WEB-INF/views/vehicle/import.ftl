<div id="importVehicle" class="modal fade " role="basic" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="importVehicleForm" class="form-horizontal" ng-submit="submit()" role="form"
                  enctype="multipart/form-data" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title"><i class="fa fa-file-text-o"></i>&nbsp;导入车辆</h4>
                </div>

                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <h4 align="center"><a href="${request.contextPath}/vehicle/downLoad?fileName=vehicle.xlsx">下载导入模板</a>
                            </h4>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <span class="input-group-addon  btn-default btn-file">
                               ...
                               <#-- <span class="fileinput-exists">替换</span>-->
                                <input type="file" name="vehicleFile" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/msexcel" required="required">
                            </span>
