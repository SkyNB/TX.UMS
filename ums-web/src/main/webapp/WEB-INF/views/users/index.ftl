                    ...
                    <div class="btn-group">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><button type="button" class="btn btn-default" v-on:click="startUser()"><i class="icon-compose"></i>启用用户</button></li>
                                <li><button type="button" class="btn btn-default" v-on:click="disableUser()"><i class="icon-cross2"></i>停用用户</button></li>
                            </ul>
                        </div>
                    </div>
                    <div class="btn-group">
...
<script src="${request.contextPath}/resources/index/demo.1.js"></script>
<script>
