angular.module('RoadnetApp').controller('PriceCreateController', ['$rootScope', '$scope', '$filter', PriceCreateController]);
function PriceCreateController($rootScope, $scope, $filter) {
    $("#addPrice").modal();
    ...
    $scope.validate = $("#addPriceForm").validate();
    ...
    $scope.ownerOptions = {
        dataSource: $scope.ownerData, filter: "contains", dataTextField: "name", dataValueField: "code"
    };
    $scope.exacctOptions = {
        dataSource: $scope.exacctData, filter: "contains", dataTextField: "name", dataValueField: "code"
    };
